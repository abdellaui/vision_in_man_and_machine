...
//ANMERKUNG: Diese drei includes werden nicht gebraucht, da pragma.h bereits alles Nötige importiert
...
int pragma::main(int argc, char *argv[])
{
	...
	*/
	...
	//ANMERKUNG: getchar() wartet einfach auf irgendeine Eingabe, also reicht es auch Return zu drücken
	// ctrl + c to close
	std::getchar();
	return 0;
}
