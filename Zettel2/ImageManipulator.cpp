...
pragma::Image::ByteImagePointer ImageManipulator::createSubImage(pragma::Image::ByteImagePointer imageA)
{
	...
	// FIXME: done!
	pragma::UINT32 xResL = (getMaxX() - getMinX());
	pragma::UINT32 yResL = (getMaxY() - getMinY());
	...
	subImageL->init(0);
	// FIXME: done!
	for (pragma::UINT32 tmpX = 0; tmpX < xResL; tmpX++)
	{
		for (pragma::UINT32 tmpY = 0; tmpY < yResL; tmpY++)
		{
